...
{ 
      ...
      document.getElementById("playList").innerHTML += `<h2 class="playlist_name_disp" id="playlist_name_disp"> <i class="fa-solid fa-headphones-simple fa-duotone fa- fa-shake"></i>${" "+list_name}</h2>`
